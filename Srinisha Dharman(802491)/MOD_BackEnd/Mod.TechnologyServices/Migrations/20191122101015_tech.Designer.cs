...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mod.TechnologyServices.Models.Mentor", b =>
                {
            ...
            modelBuilder.Entity("Mod.TechnologyServices.Models.Payment", b =>
                {
            ...
            modelBuilder.Entity("Mod.TechnologyServices.Models.Training", b =>
                {
            ...
            modelBuilder.Entity("Mod.TechnologyServices.Models.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mod.TechnologyServices.Models.Payment", b =>
                {
                    b.HasOne("Mod.TechnologyServices.Models.Mentor", "Mentor")
                        .WithMany("Payment")
                        .HasForeignKey("MentorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mod.TechnologyServices.Models.User", "User")
                        .WithMany("Payment")
            ...
            modelBuilder.Entity("Mod.TechnologyServices.Models.Training", b =>
                {
                    ...
                    b.HasOne("Mod.TechnologyServices.Models.Skills", "Skills")
                        .WithMany("Training")
